(define (script-fu-ks-rr-podpis img text pos-x pos-y font-size font-color font)
    (let (
;                (layer-opis (car (gimp-text-fontname img -1 (- frame-size 1) (- newHeight (+ frame-size podpis-font-size)) podpis 0 TRUE 22 PIXELS podpis-font-size)))
...
(define (script-fu-ks-rr img drawable frame-size frame-size-bottom frame-color podpis podpis-font podpis-font-size podpis-font-color source-prefix source source-font source-font-size source-font-color frame2-size frame2-color)
